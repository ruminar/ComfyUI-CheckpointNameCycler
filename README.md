...
切り替えモードは以下の設定を選べるぞ！
  ...
  - `fixed`: 固定。<br/>
  お気に入りの場所で立ち止まることも可能じゃな。（`Checkpoint Name Selector`とほぼ同等機能のNodeになるぞ！）
...
これと対となるNode、 **[`ComfyUI-CheckpointWidgetRefresh`](https://github.com/ruminar/ComfyUI-CheckpointWidgetRefresh)** と組み合わせることで、最強の「モデル棚卸し環境」が完成するぞ！
